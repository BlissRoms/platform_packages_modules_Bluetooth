...
public class AirPodsGen3 {
    ...
    private static final byte[] MODEL_NAME = "AirPods".getBytes();
    ...
    public static void setModelMetaData(Context context, BluetoothDevice mCurrentDevice) {
        ...
        if (isModelIconSet == false) {
            ...
            MODEL_ICON_URI = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods_Gen3, packageNames).toString().getBytes();
            MODEL_ICON_URI_LEFT = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods_Gen3_Left, packageNames).toString().getBytes();
            MODEL_ICON_URI_RIGHT = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods_Gen3_Right, packageNames).toString().getBytes();
            MODEL_ICON_URI_CASE = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods_Gen3_Case, packageNames).toString().getBytes();
