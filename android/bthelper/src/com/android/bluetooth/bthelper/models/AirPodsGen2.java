...
public class AirPodsGen2 {
    ...
    public static void setModelMetaData(Context context, BluetoothDevice mCurrentDevice) {
        ...
        if (isModelIconSet == false) {
            ...
            MODEL_ICON_URI = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods, packageNames).toString().getBytes();
            MODEL_ICON_URI_LEFT = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods_Left, packageNames).toString().getBytes();
            MODEL_ICON_URI_RIGHT = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods_Right, packageNames).toString().getBytes();
            MODEL_ICON_URI_CASE = 
                    AirPodsUtils.resToUri(context, R.drawable.AirPods_Case, packageNames).toString().getBytes();
